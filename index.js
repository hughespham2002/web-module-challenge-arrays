...
let newFlavor = "Cookies and Cream"
...
function removeLastFlavor(originalFlavors, removeLastFlavor){
 originalFlavors.pop();
 return originalFlavors
}
...
function getFlavorByIndex(originalFlavors, num2){
  
  return originalFlavors [num2]
}
...
function filterByWord(originalFlavors, string){
  ...
  for (let i = 0; i < originalFlavors.length; i++) {
    if(originalFlavors[i].includes(string)) {
      OGFlavors.push(originalFlavors[i]);
    }
  }
  return OGFlavors;
}
